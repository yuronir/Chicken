...
public class SampleList extends SherlockListActivity {
    ...
    protected List<Map<String, Object>> getData(String prefix) {							//Activity List를 받아서 메뉴에 쭉~ 뿌려줌
        ...
        List<ResolveInfo> list = pm.queryIntentActivities(mainIntent, 0); //Manifest의 카테고리가 "com.actionbarsherlock.sample.demos.EXAMPLE"인 모든 Activity를 list에 넣음.
